...
**Figure 301.2** shows the service hierarchy and how UrlStateService fits into the broader architecture:

![Service hierarchy showing URL State Service position](../docs/diagrams/state-management-specification-service-hierarchy.png)

*Figure 301.2: Service hierarchy. UrlStateService sits at the foundation, providing URL-based state that higher-level services (RequestCoordinator, ResourceManagement) build upon.*
