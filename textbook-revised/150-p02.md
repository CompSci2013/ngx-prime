...
│                     ▲        ▲     ▲                                │
│                     │        │     │                                │
│              type parameter  │     └─ return type matches T         │
│                              │                                      │
│                              └─ array element type is T             │
├─────────────────────────────────────────────────────────────────────┤
│  When Called with Numbers                                           │
│                                                                     │
│    getFirst([1, 2, 3])                                              │
│                                                                     │
│    T = number  →  arr: number[]  →  returns: number                 │
├─────────────────────────────────────────────────────────────────────┤
│  When Called with Strings                                           │
│                                                                     │
│    getFirst(['a', 'b', 'c'])                                        │
│                                                                     │
│    T = string  →  arr: string[]  →  returns: string                 │
└─────────────────────────────────────────────────────────────────────┘
```

*Figure 150.1: How TypeScript infers the generic type parameter T from the argument type and propagates it to the return type.*
