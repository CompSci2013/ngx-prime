...
**Figure 301.1** illustrates this URL-First pattern visually:

![URL-First state management data flow](../docs/diagrams/state-management-specification-url-first-pattern.png)

*Figure 301.1: The URL-First pattern. User actions update the URL, which triggers state updates that flow to all subscribed components. The URL serves as the single source of truth.*