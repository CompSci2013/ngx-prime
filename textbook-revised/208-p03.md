 ...
 *
 * window.open('/panel/grid/panel/chart', 'popout-panel', features);
 * ```
 */
 ...
 * @example
 * ```typescript
 * const context = parsePopOutRoute('/panel/automobile-discover/chart-year/chart');
 * // {
 * //   isPopOut: true,
...
export function parsePopOutRoute(url: string): PopOutContext | null {
  // Match /panel/:gridId/:panelId/:type
