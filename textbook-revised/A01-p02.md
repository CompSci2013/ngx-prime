...
| Basic Results Table | `framework/components/basic-results-table/basic-results-table.component.scss` |
| Dynamic Results Table | `framework/components/dynamic-results-table/dynamic-results-table.component.scss` |
...
**Note**: There are two table components:
- `basic-results-table` - Simplified table with essential features
- `results-table` - Full-featured table with advanced capabilities
