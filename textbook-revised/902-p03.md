...
// VERSION 1 (Section 902) - Automobile landing page styles with dark theme
...
.automobile-container {
  ...
  .features-section {
    ...
    .features-grid {
      ...
      .feature-card {
        background: linear-gradient(135deg, rgba(100, 200, 255, 0.08) 0%, rgba(75, 163, 217, 0.04) 100%);
        border-radius: 12px;
        padding: 2rem;
        ...
        &:hover {
          ...
          background: linear-gradient(135deg, rgba(100, 200, 255, 0.15) 0%, rgba(75, 163, 217, 0.08) 100%);
    ...
    .info-card {
      ...
      h3 {
        ...
        &::before {
          ...
          width: 4px;
          height: 1.4rem;
          background: linear-gradient(180deg, #64c8ff, #4ba3d9);
          border-radius: 2px;
        }
      }
