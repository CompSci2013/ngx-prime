...
- Understand how to configure Angular Router with direct component references
- Know how to structure routes for a multi-feature application
- Be able to implement route redirects for improved UX
...
| `component` | Direct component reference for eager loading |
