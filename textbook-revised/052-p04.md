...
**Figure 052.2** shows how highlights appear in the statistics panel — Tesla is highlighted while other manufacturers show their total counts:

![Statistics panel with Tesla highlighted](../e2e/screenshots/V1.3.1-statistics-highlight-tesla.png)

*Figure 052.2: Statistics panel showing highlighted manufacturer (Tesla) with segmented bar visualization. The highlighted portion represents vehicles matching the h_manufacturer=Tesla filter.*
