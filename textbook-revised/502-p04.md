...
```bash
$ ls -la src/app/domain-config/automobile/adapters/automobile-url-mapper.ts
```

### 2. TypeScript Compilation Check

```bash
$ npx tsc --noEmit src/app/domain-config/automobile/adapters/automobile-url-mapper.ts
```

### 3. Test Mapping

```typescript
import { AutomobileUrlMapper } from '@app/domain-config/automobile/adapters';
